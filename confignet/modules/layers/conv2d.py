...
from .ops.upfirdn_2d import upsample_conv_2d, conv_downsample_2d
from .tf_utils import get_runtime_coef, scaled_lrelu
...
class conv2d(tf.keras.layers.Layer):
    ...
    def call(self, inputs, training=None):
        ...
        if self.up:
            x = upsample_conv_2d(
                inputs, w, data_format="NHWC", k=[1, 3, 3, 1], impl=self.impl
            )
        elif self.down:
